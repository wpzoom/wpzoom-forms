...
class WPZOOM_Forms_Settings {
				...
				<?php foreach ( self::$settings as $setting ) : ?>
					<?php if ( self::$active_tab === $setting['tab_id'] ) : ?>
						...
						<div class="wp-tab-panel" id="<?php echo esc_attr( $setting['tab_id'] ); ?>">
							...
							<?php endif; ?>
							<?php if ( self::$active_tab === 'tab-upsell' ) : ?>
								<?php $this->upsell_panel_content(); ?>
							<?php endif; ?>
							<?php
					...
					<?php else : ?>
						...
						<?php if ( $setting['tab_id'] === 'tab-upsell' ) : ?>
							<?php $this->upsell_panel_content(); ?>
						<?php endif; ?>
	...
	public function upsell_panel_content() {
		do_action( 'wpzoom_forms_settings_upsell_page_content' );
	}
	...
	public function subscribe_form() {
		...
		<div class="wpzoom-forms-settings-subscribe-form">
            <?php $current_user = wp_get_current_user(); ?>
				<p>
				<style type="text/css">
@import url(https://assets.mlcdn.com/fonts.css?version=1750157);
</style>
<style type="text/css">
