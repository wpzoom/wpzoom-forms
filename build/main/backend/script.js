  ...
  render: function render(props) {
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useEffect)(function () {
      ...
      var handleDragOver = function handleDragOver(event) {
        ...
        handleDragOver.timeout = setTimeout(function () {
    ...
    var uniqueFieldsExist = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_7__.useSelect)(function (select) {
      ...
      var findBlockType = function findBlockType(blocks, type) {
        return blocks.some(function (block) {
          if (block.name === type) {
            return true;
          }
      ...
      var hasEmailField = findBlockType(blocks, 'wpzoom-forms/text-email-field');
      var hasNameField = findBlockType(blocks, 'wpzoom-forms/text-name-field');
      var hasSubmitField = findBlockType(blocks, 'wpzoom-forms/submit-field');
      return {
