 ...
 */
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addFilter)("editor.BlockEdit", "wpzoom-forms/conditional-logic-placeholder", (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(function (BlockEdit) {
  return function (props) {
    var name = props.name;
    if (!ALLOWED_FIELD_BLOCKS.includes(name)) {
      return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(BlockEdit, _objectSpread({}, props));
    }
    return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(BlockEdit, _objectSpread({
      key: "edit"
    }, props)), (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.__experimentalToolsPanel, {
      label: (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Conditional Logic", "wpzoom-forms"), (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)("span", {
      ...
      }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Pro', 'wpzoom-forms'))),
      dropdownMenuProps: {
        popoverProps: {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Show or hide this field based on the value of another field.', 'wpzoom-forms')), (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.Button, {
      ...
      iconPosition: "right",
      iconSize: 20
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Unlock this feature', 'wpzoom-forms'))))));
  };
...
var FormIcons = {
  ...
  number: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  time: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  gdpr: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  hidden: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    fill: "none",
...
var _findFirstBlockByName = function findFirstBlockByName(blocks, blockName) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (block.innerBlocks && block.innerBlocks.length > 0) {
        var childMatch = _findFirstBlockByName(block.innerBlocks, blockName);
        if (childMatch) {
          return childMatch;
        }
      }
...
var findPreferredFormInsertionTarget = function findPreferredFormInsertionTarget(formBlock) {
...
var getBlockNameByClientId = function getBlockNameByClientId(selectors, clientId) {
  if (!clientId) {
    return null;
  }
  ...
  var block = selectors.getBlock(clientId);
  return block ? block.name : null;
};
var isClientIdInsideForm = function isClientIdInsideForm(selectors, clientId) {
  if (!clientId) {
    return false;
  }
  var blockName = getBlockNameByClientId(selectors, clientId);
  if (blockName === 'wpzoom-forms/form') {
    return true;
  }
  var parents = typeof selectors.getBlockParents === 'function' ? selectors.getBlockParents(clientId) || [] : [];
  return parents.some(function (parentId) {
    return getBlockNameByClientId(selectors, parentId) === 'wpzoom-forms/form';
  });
};
var getFormInsertionContext = function getFormInsertionContext(selectors) {
  var allBlocks = selectors.getBlocks();
  var formBlock = _findFirstBlockByName(allBlocks, 'wpzoom-forms/form');
  if (!formBlock) {
    return null;
  }
  var preferredTarget = findPreferredFormInsertionTarget(formBlock);
  return {
    formBlock: formBlock,
...
var insertFormField = function insertFormField(blockName, defaultAttributes, isDisabled, isPro) {
  ...
  var selectors = wp.data.select('core/block-editor');
  var newBlock = createBlock("wpzoom-forms/".concat(blockName), defaultAttributes);
  var selectedBlock = selectors.getSelectedBlock();
  var focusedBlockClientId = selectors.getBlockSelectionStart();
  var insertionContext = getFormInsertionContext(selectors);
  if (!insertionContext) {
    wp.data.dispatch('core/notices').createNotice('warning', (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__.__)('Could not find a Contact Form block to insert this field.', 'wpzoom-forms'), {
      type: 'snackbar',
      isDismissible: true
    });
    return;
  }
  var selectedClientId = selectedBlock ? selectedBlock.clientId : focusedBlockClientId;
  var rootClientId = insertionContext.defaultRootClientId;
  var index;
  if (selectedClientId && isClientIdInsideForm(selectors, selectedClientId)) {
    var selectedBlockName = getBlockNameByClientId(selectors, selectedClientId);
    if (selectedBlockName !== 'wpzoom-forms/form') {
      var selectedRootClientId = selectors.getBlockRootClientId(selectedClientId);
      var selectedIndex = selectors.getBlockIndex(selectedClientId, selectedRootClientId);
    ...
    wp.data.dispatch('core/notices').createNotice('info', (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__.__)('Field added to your Contact Form. Select a form field first to insert right after it.', 'wpzoom-forms'), {
      type: 'snackbar',
      isDismissible: true
    });
  }
...
(0,_wordpress_plugins__WEBPACK_IMPORTED_MODULE_11__.registerPlugin)('wpzoom-forms-document-settings', {
  ...
  render: function render(props) {
    ...
    (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_8__.useEffect)(function () {
      ...
      var getEditorDoc = function getEditorDoc() {
        var iframe = document.querySelector('iframe[name="editor-canvas"]');
        return iframe && iframe.contentDocument && iframe.contentDocument.readyState === 'complete' ? iframe.contentDocument : document;
      };
      ...
      var handleDrop = function handleDrop(event) {
        ...
        try {
          ...
          var selectors = wp.data.select('core/block-editor');
          var getBlockRootClientId = selectors.getBlockRootClientId,
          ...
          var blockElements = getEditorDoc().querySelectorAll('[data-block]');
          ...
          if (closestBlock) {
            ...
            var targetInsideForm = isClientIdInsideForm(selectors, targetClientId);
            var canInsertNearTarget = targetInsideForm && typeof targetIndex === 'number' && targetIndex >= 0;
            if (canInsertNearTarget) {
              ...
              wp.data.dispatch('core/notices').createNotice('info', (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__.__)('Field added to your Contact Form. Drop over the form to place it more precisely.', 'wpzoom-forms'), {
                type: 'snackbar',
                isDismissible: true
              });
            }
      ...
      var attachEditorListeners = function attachEditorListeners() {
        var editorDoc = getEditorDoc();
        var editor = editorDoc.querySelector('.block-editor-block-list__layout');
      ...
      if (!attachEditorListeners()) {
        var retryTimer = setTimeout(attachEditorListeners, 800);
        return function () {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_10__.__)('Click or drag a field to add it to your form.', 'wpzoom-forms')), (0,react__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", {
    ...
    })))), (0,react__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_editor__WEBPACK_IMPORTED_MODULE_9__.PluginDocumentSettingPanel, {
      ...
      var handleDrop = function handleDrop(event) {
        ...
        try {
          ...
          var _JSON$parse2 = JSON.parse(data),
            ...
            attributes = _JSON$parse2.attributes;
          ...
          var _wp$data$select = wp.data.select('core/block-editor'),
            ...
            getBlockIndex = _wp$data$select.getBlockIndex;
          var newBlock = createBlock(type, attributes);
